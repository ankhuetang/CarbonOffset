...
const Navbar = () => {
  ...
  return (
    <nav
      className="flex justify-between items-center h-16 bg-gradient-to-r from-green-500 to-blue-500 text-white relative shadow-sm font-extrabold text-lg"
      role="navigation"
    >
      ...
      <div className={`pr-8 md:block ${isOpen ? "block" : "hidden"}`}>
        ...
        <a href="/marketplace" className="p-4 text-white">
          Marketplace
        </a>
